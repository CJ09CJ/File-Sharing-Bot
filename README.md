...
#### Deploy in your VPS
````bash
git clone https://github.com/Mobmovies/filesharebot
cd MM-File-Sharing-Bot
...
[MM-File-Sharing-Bot](https://github.com/Mobmovies/filesharebot/) is Free Software: You can use, study share and improve it at your
